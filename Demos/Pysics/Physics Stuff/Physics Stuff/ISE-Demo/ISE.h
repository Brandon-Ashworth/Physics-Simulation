...
// ------------------------------ Game Object											#II
	...
	void GOsetGameModelPos(int index, Vector3 pos);

	Vector3 GOgetGameModelPos(int index);

	void GOsetGameModelRotation(int index, Vector3 rot);

	void GOaddGameModelRotation(int index, Vector3 rot);
	
	void GOaddGameModelPosition(int index, float x, float y, float z);
	...
	void GOsetGameObjectXPos(int index, int x);
	...
	void GOsetGameObjectYPos(int index, int y);
	...
	void GOsetGameObjectZPos(int index, int z);
