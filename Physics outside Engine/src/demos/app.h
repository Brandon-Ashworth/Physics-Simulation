...
protected:
    ...
    engine::Particle *particleArray;
    engine::GroundContacts groundContactGenerator;
 ...
 */
 ...
 protected:
    ...
    engine::Contact contacts[maxContacts];

    /** Holds the collision data structure for collision detection. */
    engine::CollisionData cData;

    /** Holds the contact resolver. */
    engine::ContactResolver resolver;
    ...
    virtual void updateObjects(engine::real duration) = 0;
